...
setaddupdatebtn("Add")
  ...
  const handlePreview=(materialId,materialType)=>{
    ...
    switch (materialType) {
      ...
      case 'VIDEO':
        setSelectedComponent(<>Invalid video content</>)
        break;
                    ...
                    <ListGroup.Item>
                      <div>
                        <div class="row">
                          ...
                          <div class="col">
                            <button className='ms-1 ' onClick={()=>handlePreview(content.materialId,content.materialType)}   ><IoEyeOutline fontSize={20}/></button>
